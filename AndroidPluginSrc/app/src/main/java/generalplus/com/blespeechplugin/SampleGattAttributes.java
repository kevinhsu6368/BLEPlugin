...
public class SampleGattAttributes {
    ...
    public static String FFF0_CHARACTERISTIC = "0000fff0-0000-1000-8000-00805f9b34fb";  // service
    public static String FFF1_CHARACTERISTIC = "0000fff1-0000-1000-8000-00805f9b34fb";  //   C1 / SDB_BT / DB-2-Pro ---- Android - Read
    public static String FFF2_CHARACTERISTIC = "0000fff2-0000-1000-8000-00805f9b34fb";  //   C1 / SDB_BT / DB-2-Pro ---- Android - Write
    public static String FFF4_CHARACTERISTIC = "0000fff4-0000-1000-8000-00805f9b34fb";  //   DB-2 ---- Android - Read
    public static String FFF5_CHARACTERISTIC = "0000fff5-0000-1000-8000-00805f9b34fb";  //   DB-2 ---- Android - Write (DB-2 not use)
